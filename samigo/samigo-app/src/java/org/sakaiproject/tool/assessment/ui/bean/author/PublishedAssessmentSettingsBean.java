...
public void setFeedbackComponentOption(String feedbackComponentOption) {
  ...
  public String getStartDateInClientTimezoneString() {
    if (!this.isValidStartDate) {
      ...
      return userTimeService.dateTimeFormat(startDate, new ResourceLoader().getLocale(), DateFormat.LONG);
    }
  }
  ...
  public String getDueDateInClientTimezoneString() {
    if (!this.isValidDueDate) {
      ...
      return userTimeService.dateTimeFormat(dueDate, new ResourceLoader().getLocale(), DateFormat.LONG);
    }
  }
  ...
  public String getFeedbackDateInClientTimezoneString() {
    if (!this.isValidFeedbackDate) {
      ...
      return userTimeService.dateTimeFormat(feedbackDate, new ResourceLoader().getLocale(), DateFormat.LONG);
    }
  }
  ...
  public String getFeedbackEndDateInClientTimezoneString() {
    if (!this.isValidFeedbackEndDate) {
      ...
      return userTimeService.dateTimeFormat(feedbackEndDate, new ResourceLoader().getLocale(), DateFormat.LONG);
    }
  }
